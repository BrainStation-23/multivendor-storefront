...
export const features = {
  /**
   * PDP / Quick View: fetch `/api/storefront/variant-availability` and disable Add to cart for lines
   * the backend cannot allocate. Default **on**; set `NEXT_PUBLIC_WAREHOUSE_AVAILABILITY_UI=false` to disable.
