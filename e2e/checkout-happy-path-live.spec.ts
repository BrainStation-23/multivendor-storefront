/**
 * P0 core commerce E2E: guest checkout (MV; payment POST stubbed). Part of `yarn test:e2e:core`.
 * See docs/frontend/TESTING.md § E2E priority.
 */
import { test, expect } from "@playwright/test";
import { apiOrigin, isBackendReachable } from "./helpers/live-backend";

const storefrontOrigin = process.env.PLAYWRIGHT_BASE_URL || "http://localhost:3002";

let live = false;

test.describe("guest checkout happy path (live API + mocked payment, MV)", () => {
